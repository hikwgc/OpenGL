...
void SceneSubroutine::initScene()
{
    ...
    projection = glm::perspective(50.0f, (float)800/600, 0.3f, 100.0f);
...
{
    if( ! prog.compileShaderFromFile("/Users/kawaguchihiroshi/Developer/practice/OpenGL/GLSLChapter2/GLSLChapter2/subroutine.vert",GLSLShader::VERTEX) )
    {
        printf("Vertex shader failed to compile!\n%s",
               prog.log().c_str());
        exit(1);
    }
    if( ! prog.compileShaderFromFile("/Users/kawaguchihiroshi/Developer/practice/OpenGL/GLSLChapter2/GLSLChapter2/subroutine.frag",GLSLShader::FRAGMENT))
    {
